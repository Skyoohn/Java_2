...
<!-- 공지 -->
   <table width="500" border="1">
      ...
      <c:forEach var="boardList_notice" items="${boardList_notice}">
         <tr>
            ...
            <td>
               ...
               <a href="content_view_notice_qna?nid=${boardList_notice.nid}">${boardList_notice.ntitle}</a>
      ...
      <tr>
         <td colspan="5"> <a href="write_view_notice_qna">글 작성</a></td>
      </tr>
   </table>
      ...
      <c:forEach var="boardList" items="${boardList}">
         <tr>
            ...
            <td>
               ...
               <a href="content_view_only?qid=${boardList.qid}">${boardList.qtitle}</a>
                    <!--bindent : 가로 (댓글이 보이는 순서 때문에 들어간 것)-->
            </td>
...
<%--             <td>${board.bhit}</td>   --%>          
      ...
      <tr>
         <td colspan="5"> <a href="write_view_only">글 작성</a></td>
      </tr>
   </table>
