			   ...
			   <div class="table-responsive text-nowrap">
			     <table class="table">
			       ...
			       <tbody>
			         ...
			         <tr>
		<%-- 	           <td><strong><c:forEach begin="1" end="${boardList_Qna.bindent}"></c:forEach></strong></td> --%>
			           ...
			           <td>
			             <div class="dropdown">
			               ...
			               <div class="dropdown-menu">
			                 ...
			                 <a class="dropdown-item" href="delete?bid=${boardList_Qna.bid}"><i class="bx bx-trash me-1"></i> Delete</a>
			               </div>
			             </div>
			           </td>
			         </tr>
			         ...
			         <tr>
<%-- 			           <td><strong><c:forEach begin="1" end="${boardList_Review.bindent}"></c:forEach></strong></td> --%>
			           ...
			           <td>
			             <div class="dropdown">
			               ...
			               <div class="dropdown-menu">
			                 <a class="dropdown-item" href="#"><i class="bx bx-edit-alt me-1"></i> Edit</a>
			                 <a class="dropdown-item" href="delete?bid=${boardList_Review.bid}"><i class="bx bx-trash me-1"></i> Delete</a>
			               </div>
			             </div>
			           </td>
			         </tr>
