...
//	@GetMapping 
//	public String view(@RequestParam("bid") long bid, Model model) {
//		return boardService.view(bid);
//	}
	
//	@RequestMapping(value="/viewcount")
//	public ModelAndView detail(@RequestParam("bid") String bid) throws Exception {
//		
//		// 기존의 게시글 자세히 보기에서 추가된 부분
//		boardService.viewcount(bid);
//		
//		return new ModelAndView("detail","detail1",boardService.viewcount(bid));
//	}
	
//	@RequestMapping(value = "/projectDetailForm.do")
//	public String updatereviewcnt(@ModelAttribute("projectVO") BoardVO boardVO, Model model) {
//
//		// 조회수 증가
//		boardService.viewcount(boardVO.getBid());
//		
//	    List<PageVO> list = boardService.viewcount(boardVO.getBid());
//
