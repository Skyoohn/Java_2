   ...
   private void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      if(com.equals("/list.do")) {
         ...
         viewPage = "content_view.jsp";
          ...
          //http://localhost:8282/jsp_hjs_mvc_board/write.do
          ...
          //http://localhost:8282/jsp_hjs_mvc_board/delete.do
           command = new BoardDeleteCommand();
           command.execute(request, response);
           
           viewPage = "list.do";
       }else if(com.equals("/reply_view.do")) {
          //http://localhost:8282/jsp_hjs_mvc_board/reply_view.do
           command = new BoardReplyViewCommand();
           command.execute(request, response);
           
           viewPage = "reply_view.jsp";
       }else if(com.equals("/reply.do")) {
          //http://localhost:8282/jsp_hjs_mvc_board/reply.do
      ...
      /*
         클라이언트에게 list.do는 list.jsp로 forwarding을 시키겠다는 의미이다.
          ...
          list.jsp에서 사용가능하다는 의미다. 
          
          forwarding될때까지 정보가 살아있기 때문이다. 
