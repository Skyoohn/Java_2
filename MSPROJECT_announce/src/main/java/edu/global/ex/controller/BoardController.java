...
public class BoardController {
	...
	public String list(Model model) {
		...
		model.addAttribute("boardList",boardService.getList1());
...
//		model.addAttribute("boardList2",boardService.getListWithPaging1(cri));
		model.addAttribute("boardList",boardService.getListWithPaging(cri));
		
		int total = boardService.getTotal();
		log.info("list2() 게시판 전체 갯수" + total);
		
//		int total1 = boardService.getTotal1();
//		log.info("list2() 게시판 전체 갯수" + total1);
		
//		model.addAttribute("pageMaker1",new PageVO(cri,total1));
